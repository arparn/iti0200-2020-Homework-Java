...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        number4 = new Number((short) NUM4, true, true);
        number5 = new Number((short) NUM5, true, true);
        number6 = new Number((short) NUM6, true, true);
        number7 = new Number((short) NUM7, true, true);
        number8 = new Number((short) NUM8, true, true);
        number9 = new Number((short) NUM9, true, true);
